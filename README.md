# Assembly Line Operations Manager
...
- Add a new operation using a modal form
- Remove an operation
- Assign a device to an operation using a modal form
- Device types defined using an enum
